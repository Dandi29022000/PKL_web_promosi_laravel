                        ...
                        <div class="shop-product-content tab-content">
                            <div id="grid-sidebar3" class="tab-pane fade active show">
                                ...
                                <div class="row">
                                    ...
                                    @forelse ($Water as $Wat)
                                        <!-- grid box -->
                                        <div class="col-md-6 col-xl-4">
                                            <div class="product-wrapper mb-30">
                                                <div class="product-img">
                                                    <a href="{{ url('/frontend-water') }}">
                                                        <img src="{{asset('storage/'.$Wat->gambar)}}"  alt="{{ $Wat->nama }}">
                                                    </a>
                                                    <span>hot</span>
                                                    <div class="product-action">
                                                        <a class="btn-primary text-center" href="{{ route('frontend.water-detail', $Wat->id) }}">
                                                            <i class="pe-7s-look"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="product-content text-center">
                                                    <h4><a href="{{ url('/frontend-water') }}">{{ $Wat->nama }}</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end -->
