											...
											<form method="post" action="{{ route('frontend.entertainment-sewa', $Entertainment->id) }}">
												...
												<ul class="list-group list-group-unbordered mb-4">
													<li class="list-group-item">
														<b>Ukuran</b> <b class="float-right">{{ $Entertainment->ukuran }}</b>
													</li>
													<li class="list-group-item">
														<b>Listrik</b> <b class="float-right">{{ $Entertainment->listrik }}</b>
													</li>
													<li class="list-group-item">
														<b>Usia</b> <b class="float-right">{{ $Entertainment->usia }}</b>
													</li>
													<li class="list-group-item">
														<b>Crew</b> <b class="float-right">{{ $Entertainment->crew }}</b>
													</li>
												</ul>
												...
												<div class="row">
													<div class="col-md-6">
														<a href="{{ route('frontend.entertainment') }}" class="btn btn-warning btn-block py-1"><b>Kembali</b></a>
													</div>
													<div class="col-md-6">
