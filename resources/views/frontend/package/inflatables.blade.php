                    ...
                    <div class="shop-bar-area">
                        <div class="shop-product-content tab-content">
                            <div id="grid-sidebar3" class="tab-pane fade active show">
                                ...
                                <h4 class="text-center font-weight-bold m-4">INFLATABLES</h4>
                                <!-- grid view -->
                                <div class="row">
                                    
                                    @forelse ($Inflatable as $Inf)
                                        <!-- grid box -->
                                        <div class="col-md-6 col-xl-4">
                                            <div class="product-wrapper mb-30">
                                                <div class="product-img">
                                                    <a href="{{ url('/frontend-inflatables') }}">
                                                        <img src="{{asset('storage/'.$Inf->gambar)}}"  alt="{{ $Inf->nama }}">
                                                    </a>
                                                    <span>hot</span>
                                                    <div class="product-action">
                                                        <a class="btn-primary text-center" href="{{ route('frontend.inflatables-detail', $Inf->id) }}">
                                                            <i class="pe-7s-look"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="product-content text-center">
                                                    <h4><a href="{{ url('/frontend-inflatables') }}">{{ $Inf->nama }}</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end -->
