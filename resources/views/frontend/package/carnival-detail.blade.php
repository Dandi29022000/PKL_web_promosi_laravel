									...
									<div class="card card-primary card-outline">
										...
										<div class="card-body box-profile  ml-4 mr-4">
											...
											<form method="post" action="{{ route('frontend.carnival-sewa', $Carnival->id) }}">
												...
												<div class="row">
													<div class="col-md-6">
														<a href="{{ route('frontend.carnival') }}" class="btn-warning btn-block py-1"><b>Kembali</b></a>
													</div>
													<div class="col-md-6">
														<button type="submit" class="btn-primary btn-block py-1"><i class="fa-solid fa-cart-shopping"></i><b> Masukkan Keranjang</b></button>
													</div>
												</div>
											</form>
										</div>
