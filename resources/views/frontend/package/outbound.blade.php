    ...
    <div class="row justify-content-center mx-auto mt-5">
        ...
        @foreach($Outbound as $Out)
            <div class="card bg-light ml-2 mr-4 mb-4" style="width: 18rem;" >
                <img width="150px" src="{{asset('storage/'.$Out->gambar)}}"  class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <br>
                    <a href="{{ route('frontend.outbound-detail', $Out->id) }}" class="btn btn-primary"><i class="fas fa-eye"></i> Detail</a>
                </div>
            </div>
        @endforeach
    </div>
