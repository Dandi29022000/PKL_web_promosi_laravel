                        ...
                        <div class="shop-product-content tab-content">
                            <div id="grid-sidebar3" class="tab-pane fade active show">
                                ...
                                <div class="row">
                                    ...
                                    @forelse ($Electrical as $Ele)
                                        <!-- grid box -->
                                        <div class="col-md-6 col-xl-4">
                                            <div class="product-wrapper mb-30">
                                                <div class="product-img">
                                                    <a href="{{ url('/frontend-electrical') }}">
                                                        <img src="{{asset('storage/'.$Ele->gambar)}}"  alt="{{ $Ele->nama }}">
                                                    </a>
                                                    <span>hot</span>
                                                    <div class="product-action">
                                                        <a class="btn-primary text-center" href="{{ route('frontend.electrical-detail', $Ele->id) }}">
                                                            <i class="pe-7s-look"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="product-content text-center">
                                                    <h4><a href="{{ url('/frontend-electrical') }}">{{ $Ele->nama }}</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end -->
