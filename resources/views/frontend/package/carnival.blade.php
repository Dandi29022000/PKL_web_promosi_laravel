                        ...
                        <div class="shop-product-content tab-content">
                            <div id="grid-sidebar3" class="tab-pane fade active show">
                                ...
                                <div class="row">
                                    ...
                                    @forelse ($Carnival as $Car)
                                        <!-- grid box -->
                                        <div class="col-md-6 col-xl-4">
                                            <div class="product-wrapper mb-30">
                                                <div class="product-img">
                                                    <a href="{{ url('/frontend-carnival') }}">
                                                        <img src="{{asset('storage/'.$Car->gambar)}}"  alt="{{ $Car->nama }}">
                                                    </a>
                                                    <span>hot</span>
                                                    <div class="product-action">
                                                        <a class="btn-primary text-center" href="{{ route('frontend.carnival-detail', $Car->id) }}">
                                                            <i class="pe-7s-look"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="product-content text-center">
                                                    <h4><a href="{{ url('/frontend-carnival') }}">{{ $Car->nama }}</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end -->
