									...
									<div class="card card-primary card-outline">
										...
										<div class="card-body box-profile  ml-4 mr-4">
											<div class="text-center">
												<img class="profile-user-img img-fluid img-circle" width="400px" src="{{asset('storage/'.$Outbound->gambar)}}" alt="User profile picture">
											</div>
											<br>

											<form method="post" action="{{ route('frontend.outbound-sewa', $Outbound->id) }}">
												@csrf
												<h3 class="profile-username text-center">{{ $Outbound->nama }}</h3>

												<p class="text-muted text-justify">{{ $Outbound->deskripsi }}</p>

												<ul class="list-group list-group-unbordered mb-4">
													<li class="list-group-item">
														<b>Ukuran</b> <b class="float-right">{{ $Outbound->ukuran }}</b>
													</li>
													<li class="list-group-item">
														<b>Listrik</b> <b class="float-right">{{ $Outbound->listrik }}</b>
													</li>
													<li class="list-group-item">
														<b>Usia</b> <b class="float-right">{{ $Outbound->usia }}</b>
													</li>
													<li class="list-group-item">
														<b>Crew</b> <b class="float-right">{{ $Outbound->crew }}</b>
													</li>
												</ul>
												...
												<div class="row">
													<div class="col-md-6">
														<a href="{{ route('frontend.outbound') }}" class="btn btn-warning btn-block py-1"><b>Kembali</b></a>
													</div>
													<div class="col-md-6">
