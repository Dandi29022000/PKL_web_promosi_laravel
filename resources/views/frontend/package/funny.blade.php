...
<div class="breadcrumb-area pt-205 breadcrumb-padding pb-210" style="background-image: url({{ asset('img/2.jpg') }})">
    <div class="container-fluid">
        <div class="breadcrumb-contFun text-cFuner">
            ...
            <div class="col-lg-9">
                <div class="shop-product-wrapper res-xl">
                    <div class="shop-bar-area">
                        <div class="shop-product-contFun tab-contFun">
                            <div id="grid-sidebar3" class="tab-pane fade active show">

                                <h4 class="text-cFuner font-weight-bold m-4">FUNNY</h4>
                                <!-- grid view -->
                                <div class="row">
                                    
                                    @forelse ($Funny as $Fun)
                                        <!-- grid box -->
                                        <div class="col-md-6 col-xl-4">
                                            <div class="product-wrapper mb-30">
                                                <div class="product-img">
                                                    <a href="{{ url('/frontend-funny') }}">
                                                        <img src="{{asset('storage/'.$Fun->gambar)}}"  alt="{{ $Fun->nama }}">
                                                    </a>
                                                    <span>hot</span>
                                                    <div class="product-action">
                                                        <a class="btn-primary text-cFuner" href="{{ route('frontend.funny-detail', $Fun->id) }}">
                                                            <i class="pe-7s-look"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="product-contFun text-cFuner">
                                                    <h4><a href="{{ url('/frontend-funny') }}">{{ $Fun->nama }}</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end -->
