                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="tanggal_lahir" class="form-control" id="tanggal_lahir" aria-describedby="tanggal_lahir" placeholder="dd-mm-yyyy" value="{{ old('tanggal_lahir') }}" min="1950-01-01" max=<?php echo date('Y-m-d'); ?>
